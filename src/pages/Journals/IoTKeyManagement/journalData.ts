...
export const articleData: JournalArticle = {
  ...
  intro: {
    en: "This system was born from a genuine operational need: automatically logging the physical movement of keys in a warehouse or laboratory environment, without relying on a human operator. Instead of deploying an expensive proprietary system, I engineered an ESP32-based solution capable of identity validation, real-time logging to Google Sheets, and maintaining data accuracy even through unexpected power failures.",
    id: "Sistem ini lahir dari kebutuhan nyata: mencatat keluar-masuk kunci fisik secara otomatis di lingkungan gudang atau laboratorium tanpa ketergantungan pada operator manusia. Alih-alih menggunakan sistem proprietary yang mahal, saya merancang solusi berbasis ESP32 yang mampu memvalidasi identitas, mencatat log secara real-time ke Google Sheets, dan mempertahankan keakuratan data bahkan saat sistem dimatikan secara tiba-tiba."
  },
  sections: {
    hardware: {
      en: {
