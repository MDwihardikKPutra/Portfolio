...
export const articleData: JournalArticle = {
  ...
  intro: {
    en: "PT Puri Ganesha Engineering's daily operations were severely hindered by scattered project files and the lack of a secure, unified collaboration platform for both office and remote employees. Recognizing the high risk of data fragmentation and operational inefficiency, I took the initiative to architect a comprehensive private cloud solution for the office. I built and deployed a centralized server using TrueNAS Scale and Nextcloud, securely routed through a Cloudflare Zero-Trust Tunnel. This resolved their access bottlenecks entirely, eliminating the need for complex VPNs while guaranteeing enterprise-grade data security.",
    id: "Operasi harian PT Puri Ganesha Engineering sangat terhambat oleh file proyek yang tersebar dan tidak adanya platform kolaborasi terpadu yang aman untuk karyawan di kantor maupun jarak jauh. Menyadari tingginya risiko fragmentasi data dan inefisiensi operasional, saya berinisiatif merancang solusi cloud privat yang komprehensif untuk kantor. Saya membangun dan men-deploy server terpusat menggunakan TrueNAS Scale dan Nextcloud, yang dirutekan secara aman melalui Cloudflare Zero-Trust Tunnel. Hal ini menyelesaikan masalah kebuntuan akses mereka secara tuntas, mengeliminasi kebutuhan akan VPN yang rumit sekaligus menjamin keamanan data tingkat enterprise."
  },
  sections: {
    hostSpecs: {
      en: {
