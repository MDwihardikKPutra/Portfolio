...
export default function ShaderBackground(){
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      const h = Math.floor((canvas.clientHeight||200)*dpr)
  ...
  return (
    <div className="w-full h-[200px] relative overflow-hidden">
      <canvas ref={ref} className="block w-full h-full bg-black" />
      <pre ref={preRef} className="absolute top-2 left-2 text-green-500 whitespace-pre-wrap text-xs" />
    </div>
  )
}
