...
export const MainLayout = ({
  ...
  return (
    <div
      className={`h-[100dvh] w-full flex items-center justify-center p-0 md:p-6 lg:p-10 overflow-hidden transition-colors duration-300 bg-black text-[#f5f5f5] grain-overlay`}
    >
      <div
